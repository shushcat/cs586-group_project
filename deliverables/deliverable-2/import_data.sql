...
Field,Type,Short Description for Interactive,Description,Source
`unitid`, int(11),,"Dept. of Education, The Integrated Postsecondary Education Data System (Ipeds) ID","Dept. of Education, The Integrated Postsecondary Education Data System (Ipeds)"
`instnm`,varchar(255),,Institution Name in Ipeds,"Dept. of Education, The Integrated Postsecondary Education Data System (Ipeds)"
`chronname`, varchar(255,Institution,Chronicle Institution Name,Chronicle
...
indirect_facil_admin_support`,bigint(13),Facilities and services provided by the institution not charged to athletics,"Per NCAA Revenue/Expense form: Includes value of facilities and services provided by the institution not charged to athletics. This support  may include an allocation for institutional administrative cost, facilities and maintenance, grounds and field maintenance, security, risk management, utilities, depreciation and debt service. If your institution does not currently track indirect institutional support, consult your business office for a reasonable allocation. If counted here, include offsetting expenditure equal in value in Expense Category 32 (Indirect Facilities and Administrative Support).","NCAA Revenue and Expense Reports, line 8"
