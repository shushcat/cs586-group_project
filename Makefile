...
# Saved under `./ICPSR_30022`.

# College scorecard:
# https://ed-public-download.scorecard.network/downloads/College_Scorecard_Raw_Data_01162025.zip

# _The Huffington post_ and _Chronicle of higher education_'s [data on how college's finance their athletics:
# http://hpin.s3.amazonaws.com/ncaa-financials/ncaa-financials-data.zip
...
# https://www2.census.gov/programs-surveys/qtax/tables/historical/2009Q1-2024Q3-QTAX-Table1.xlsx
